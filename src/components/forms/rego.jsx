...
export function RegForm() {
  ...
  const registrationSchema = Joi.object({
    pxnumber: Joi.number()
      .min(4, t('forms.rego.fields.px.numberError'))
      .max(4, t('forms.rego.fields.px.numberError'))
      .required('You must capture the patient number')
  })
                      ...
                      <div className="col-span-6 sm:col-span-3">
                        ...
                        <div className="mt-1 flex rounded-md shadow-sm">
                          <div className="relative flex items-stretch flex-grow focus-within:z-10">
                            ...
                            />
                            <div className="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none"><ExclamationCircleIcon className="h-5 w-5 text-red-500" aria-hidden="true" /></div>
                          </div>
