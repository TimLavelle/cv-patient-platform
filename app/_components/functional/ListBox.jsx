...
import { CheckBadgeIcon, ChevronUpDownIcon } from '@heroicons/react/24/solid';
  ...
  return (
    <>
      <Listbox name={listName} value={listState[optionID]} onChange={changedState}>
        {({ open }) => (
          <>
            <Listbox.Label className="block text-sm font-medium text-gray-700">{listLabel} <CheckBadgeIcon className="h-5 w-5 text-blue-500 pl-1 inline" aria-hidden="true" /></Listbox.Label>
